...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5956160709:AAHPTf3PfjgSrJ8FDlpm_qkp7jhHg927y7A"
else:
    tgkey = tgenv
print(tgenv)
